  ...
  return [
    ...(user?.allowTrial
      ? [
          {
            title: t(
              'faq_am_i_going_to_be_charged_by_kuku',
              'Am I going to be charged by Kuku?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_kuku_will_hold',
              'To confirm credit card information Kuku will hold $2 and release it immediately'
            ),  
          },
        ]
      : []),
    {
      title: t(
        'faq_can_i_trust_kuku_kuku',
        `Can I trust ${isGeneral ? 'Kuku' : 'Kuku'}?`
      ),
      description: t(
        'faq_kuku_kuku_is_proudly_open_source',
        `${
          isGeneral ? 'Kuku' : 'Kuku'
        } is proudly open-source! We believe in an ethical and transparent culture, meaning that ${
          isGeneral ? 'Kuku' : 'Kuku'
        } will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/sysfora/kuku" target="_blank" style="text-decoration: underline;">click here</a>.`
      ),
    },
    {
      title: t('faq_what_are_channels', 'What are channels?'),
      description: t(
        'faq_kuku_kuku_allows_you_to_schedule_posts',
        `${
          isGeneral ? 'Kuku' : 'Kuku'
